  ...
  'inline-flex items-center rounded-md border px-2.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        warning:
          'border-transparent bg-yellow-500/10 text-yellow-500 dark:bg-yellow-500/20 dark:text-yellow-400',
        info: 'border-transparent bg-blue-500/10 text-blue-500 dark:bg-blue-500/20 dark:text-blue-400',
      },
    },
    defaultVariants: {
      variant: 'default',
